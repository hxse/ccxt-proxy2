...
> **状态：Research snapshot。** 本文是 2026-01-09 的人工观测，不是实时行情、稳定 API contract 或 Provider capability 定义。实现时以 [CcxtClient 与 Provider capability](../../current_specs/ccxt_client.md) 为准。
>
