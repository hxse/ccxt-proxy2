...
> **状态：Research snapshot。** 公式和示例来自当时的 market metadata 与 sandbox 验证；下单前仍须读取当前 Provider 返回的 precision、limit 与 contract metadata。目标代码归属见 [`CcxtClient`](../../current_specs/ccxt_client.md)。
>
